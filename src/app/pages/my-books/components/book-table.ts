    ...
    <div class="space-y-10">
      ...
      <section>
        ...
        @if(booksService.readingBooks().length > 0) {
            ...
            <table class="min-w-full divide-y divide-slate-200">
              ...
              <tbody class="divide-y divide-slate-200 bg-white">
                @for (book of booksService.readingBooks(); track book.id) {
                  <tr (click)="selectBook(book)" class="hover:bg-slate-50 cursor-pointer">
                    <td class="py-4 pl-6 pr-3 font-medium text-slate-900">{{ book.title }}</td>
          ...
          <p class="text-slate-500">You're not reading any books right now.</p>
        }
      </section>
      ...
      <section>
        ...
        @if(booksService.toReadBooks().length > 0) {
          ...
          <p class="text-slate-500">Your reading list is empty. Discover a new book!</p>
        }
      </section>
      ...
      <section>
        ...
        @if(booksService.finishedBooks().length > 0) {
          ...
          <p class="text-slate-500">You haven't finished any books yet.</p>
        }
      </section>
    </div>
  `,
