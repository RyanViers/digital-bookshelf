        ...
        <div class="space-y-6">
          <div class="flex flex-col items-start justify-between gap-4 md:flex-row md:items-center">
            ...
            <div class="flex items-center gap-4">
              ...
              <button (click)="showNewForm()" class="flex items-center gap-2 rounded-md bg-indigo-600 px-4 py-2 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-indigo-700">
...
export class MyBooks {
  ...
  protected showNewForm(): void {
    ...
    this.booksService.view.set('new');
  }
}